...
class PipelineStepGenerateCoverageViz(PipelineStep):
    ...
    def run(self):
        ...
        (contig_coverage_json, contig_stats_json) = self.input_files_local[1]
        ...
        valid_contigs_with_read_counts = self.get_valid_contigs_with_read_counts(contig_stats_json)
    ...
    def get_valid_contigs_with_read_counts(self, contig_stats_json):
